...
var Auth = {
  ...
  // npm i toastr
  showMessagesLogin: function showMessagesLogin() {
    $(".js-login-message").click(function (event) {
      event.preventDefault();
      toastr__WEBPACK_IMPORTED_MODULE_0__.warning('Đăng nhập để thực hiện tính năng này');
      return;
    });
  },
...
/***/ "./resources/js/components/_inc_favourite.js":
/*!***************************************************!*\
  !*** ./resources/js/components/_inc_favourite.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  saveFavourite: function saveFavourite() {
    $('.js-favourite').click(function (event) {
      ...
      $.ajax({
        ...
        success: function success(response) {
          if (response.status === 200) {
            toastr__WEBPACK_IMPORTED_MODULE_0__.success("Thêm vào yêu thích thành công");
          }
        },
        error: function error(response) {}
      });
