...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="{{ asset('template_admin/images/favicon.png') }}"/>
    <title>System Admin - Website tuyển dụng</title>Job
    ...
    <div class="row" style="margin-top: -23px;">
                ...
                <nav class="navbar align-items-stretch navbar-light bg-white flex-md-nowrap border-bottom p-0">
                    <a class="navbar-brand w-100 mr-0" href="#" style="line-height: 25px;">
                        <div class="d-table m-auto">
                            <img id="main-logo" class="d-inline-block align-top mr-1" style="max-width: 130px;" src="{{ asset('template_admin/images/logoAdmin.png') }}" alt="Shards Dashboard">
                        </div>
                    </a>
        ...
        <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
            <div class="main-navbar sticky-top bg-white">
                <!-- Main Navbar -->
                <nav class="navbar align-items-stretch navbar-light flex-md-nowrap p-0" style="justify-content: flex-end;">
                    <ul class="navbar-nav border-left flex-row ">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-nowrap px-3" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                                <img class="user-avatar rounded-circle mr-2" src="{{ asset('template_admin/images/avatars/admin.png') }}" alt="User Avatar">
...
<script src="{{ asset('template_admin/extras.1.1.0.min.js') }}"></script>
