                    ...
                    <div class="col-lg-9 column">
                        <div class="padding-left">
                            <div class="manage-jobs-sec addscroll">
                                <h3>Danh sách công việc <a href="{{route('get_employer.job.create')}}" class="btn btn-primary"> Thêm mới job</a> </h3>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="action_job">
                                                ...
                                                <li><span>Delete</span><a href="{{ route('get_employer.job.delete', $item->id) }}" title=""><i class="la la-trash-o"></i></a></li>
                                            </ul>
                                        </td>
                                    </tr>
                                    @endforeach
