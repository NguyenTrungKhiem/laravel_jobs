<form action="" method="POST">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="pf-field">
                <input type="text" placeholder="Address" name="j_address" value="{{ old('j_address', $job->j_address ?? '') }}">
            </div>
...
{{--                            {{ old('j_career_id', ($job->j_career_id ?? 0)) == $item->id ? 'selected' : "" }}>{{ $item->c_name }}--}}
{{--                        </option>--}}
{{--                    @endforeach--}}
{{--                </select>--}}
...
{{--        </div>--}}
        ...
        <div class="col-lg-6">
            <span class="pf-title">Làm thêm giờ (OT)</span>
            <div class="pf-field">
