                                ...
                                <form action="{{ route('get_employer.company.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            {{--    HIỆN THỊ LỖI KHI KHÔNG NHẬP NAME CÔNG TY--}}
...
{{--                                        </div>--}}
                                     ...
                                     {{--      $company->c_address ?? ''// Nếu tồn tại thì nó show k có thì trả về null --}}
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="">
{{--                                                js-run-select2 --}}
                                                <select name="careers[]" data-placeholder="Please Select Specialism" class="chosen "
                                                        style="display: none;" multiple="multiple">
                                                    @foreach($careers as  $item)
                                                        <option value="{{ $item->id }}" {{ in_array($item->id, $careersCompany) ? "selected" : "" }}>
                                                            {{ $item->c_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <span class="pf-title">Số điện thoại công ty</span>
                                            <div class="pf-field">
                                        ...
                                        <div class="col-lg-6">
                                            <span class="pf-title">Logo công ty</span>
                                            <div class="pf-field">
